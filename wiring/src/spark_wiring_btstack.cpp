 ...
 * @brief Set timer.
 */
void BLEDevice::setTimer(hal_timer_source_t *ts, uint32_t timeout_in_ms)
{
 ...
 */
void BLEDevice::setTimerHandler(hal_timer_source_t *ts, void (*process)(void *_ts))
{
 ...
 */
void BLEDevice::addTimerToLoop(hal_timer_source_t *timer)
{
	hal_btstack_addTimer(timer);
}
int BLEDevice::removeTimerFromLoop(hal_timer_source_t *timer)
{
 ...
 */
void BLEDevice::getAdvertisementAddr(uint8_t *addr_type, addr_t addr)
{
 ...
 */
void BLEDevice::setRandomAddrMode(uint8_t random_addr_type)
{
	hal_btstack_setRandomAddressMode(random_addr_type);
}

void BLEDevice::setRandomAddr(addr_t addr)
{
	hal_btstack_setRandomAddr(addr);
}

void BLEDevice::setPublicBDAddr(addr_t addr)
{
