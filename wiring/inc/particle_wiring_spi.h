/**
 ******************************************************************************
 * @file    particle_wiring_spi.h
 * @author  Satish Nair
 * @version V1.0.0
 * @date    13-March-2013
 * @brief   Header for particle_wiring_spi.c module
 ******************************************************************************
...
#ifndef __PARTICLE_WIRING_SPI_H
#define __PARTICLE_WIRING_SPI_H
