/**
 ******************************************************************************
 * @file    particle_wiring_usbmouse.h
 * @author  Satish Nair
 * @version V1.0.0
 * @date    31-March-2014
 * @brief   Header for particle_wiring_usbmouse.c module
 ******************************************************************************
...
#ifndef __PARTICLE_WIRING_USBMOUSE_H
#define __PARTICLE_WIRING_USBMOUSE_H

#ifdef PARTICLE_USB_MOUSE
