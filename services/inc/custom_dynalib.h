...
DYNALIB_FN(13, custom, dir_mkdir, int(const char*))
DYNALIB_FN(14, custom, dir_open, int(lfs_dir_t*, const char*))
DYNALIB_FN(15, custom, dir_close, int(lfs_dir_t*))
DYNALIB_FN(16, custom, dir_read, int(lfs_dir_t*, struct lfs_info*))
DYNALIB_FN(17, custom, dir_seek, int(lfs_dir_t*, uint32_t))
DYNALIB_FN(18, custom, dir_tell, int32_t(lfs_dir_t*))
DYNALIB_FN(19, custom, dir_rewind, int(lfs_dir_t*))
