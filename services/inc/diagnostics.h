...
#define DIAG_NAME_NETWORK_SIGNAL_STRENGTH_DEPRECATED "net:sigstrdepr"
#define DIAG_NAME_NETWORK_SIGNAL_STRENGTH_VALUE "net:sigstrv"
#define DIAG_NAME_NETWORK_SIGNAL_QUALITY "net:sigqual"
#define DIAG_NAME_NETWORK_SIGNAL_QUALITY_DEPRECATED "net:sigqualdepr"
...
typedef enum diag_id {
    ...
    DIAG_ID_NETWORK_SIGNAL_STRENGTH_DEPRECATED = 33, // net:sigstrdepr
    DIAG_ID_NETWORK_SIGNAL_QUALITY_DEPRECATED = 34, // net:sigqualdepr
    DIAG_ID_NETWORK_SIGNAL_QUALITY_VALUE = 35, // net:sigqualv
    DIAG_ID_NETWORK_SIGNAL_STRENGTH = 38, // net:sigstr
    DIAG_ID_NETWORK_SIGNAL_QUALITY = 39, // net:sigqual
