...
constexpr const char* DIAG_NAME_SYSTEM_SYSTEM_LOOPS = "sys:loops";
constexpr const char* DIAG_NAME_SYSTEM_APPLICATION_LOOPS = "app:loops";
constexpr const char* DIAG_NAME_SYSTEM_UPTIME = "sys:uptime";
constexpr const char* DIAG_NAME_SYSTEM_BATTERY_STATE = "batt:state";
constexpr const char* DIAG_NAME_NETWORK_CONNECTION_STATUS = "net:status";
constexpr const char* DIAG_NAME_NETWORK_CONNECTION_ERROR_CODE = "net:error";
constexpr const char* DIAG_NAME_NETWORK_DISCONNECTS = "net:disconn";
...
constexpr const char* DIAG_NAME_NETWORK_COUNTRY_CODE = "net:country";
constexpr const char* DIAG_NAME_NETWORK_RSSI = "net:rssi";
constexpr const char* DIAG_NAME_CLOUD_CONNECTION_STATUS = "cloud:status";
constexpr const char* DIAG_NAME_CLOUD_CONNECTION_ERROR_CODE = "cloud:error";
...
constexpr const char* DIAG_NAME_CLOUD_RATE_LIMITED_EVENTS = "pub:throttle";
