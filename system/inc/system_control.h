...
typedef enum ctrl_request_type {
    ...
    // Key management
    CTRL_REQUEST_SET_DEVICE_PRIVATE_KEY = 600,
    CTRL_REQUEST_GET_DEVICE_PRIVATE_KEY = 601,
    CTRL_REQUEST_GET_DEVICE_PUBLIC_KEY = 602,
    CTRL_REQUEST_SET_SERVER_PUBLIC_KEY = 603,
    CTRL_REQUEST_GET_SERVER_PUBLIC_KEY = 604,
