...
DYNALIB_FN(16, system_ledger, ledger_set_page_callbacks, void(ledger_page*, const ledger_page_callbacks*, void*))
DYNALIB_FN(17, system_ledger, ledger_set_page_app_data, void(ledger_page*, void*, ledger_destroy_app_data_callback, void*))
DYNALIB_FN(18, system_ledger, ledger_get_page_app_data, void*(ledger_page*, void*))
DYNALIB_FN(19, system_ledger, ledger_get_page_info, int(ledger_page*, ledger_page_info*, void*))
DYNALIB_FN(20, system_ledger, ledger_sync_page, int(ledger_page*, const ledger_sync_options*, void*))
DYNALIB_FN(21, system_ledger, ledger_unlink_page, int(ledger_page*, void*))
DYNALIB_FN(22, system_ledger, ledger_remove_page, int(ledger_page*, void*))
DYNALIB_FN(23, system_ledger, ledger_open_page, int(ledger_stream**, ledger_page*, int, void*))
DYNALIB_FN(24, system_ledger, ledger_close_stream, int(ledger_stream*, int, void*))
DYNALIB_FN(25, system_ledger, ledger_rewind_stream, int(ledger_stream*, void*))
DYNALIB_FN(26, system_ledger, ledger_read, int(ledger_stream*, char*, size_t, void*))
DYNALIB_FN(27, system_ledger, ledger_write, int(ledger_stream*, const char*, size_t, void*))
