...
DYNALIB_FN(25, system_ledger, ledger_read, int(ledger_stream*, char*, size_t, void*))
DYNALIB_FN(26, system_ledger, ledger_write, int(ledger_stream*, const char*, size_t, void*))
