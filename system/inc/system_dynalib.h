...
DYNALIB_FN(22, system, system_set_usb_request_app_handler, void(usb_request_app_handler_type, void*))
DYNALIB_FN(23, system, system_set_usb_request_result, void(USBRequest*, int, void*))
#define BASE_IDX 24
#else
#define BASE_IDX 22
