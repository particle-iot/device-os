...
DYNALIB_FN(BASE_IDX4 + 3, system, system_print_log_file, int(const system_print_log_file_options*))
DYNALIB_FN(BASE_IDX4 + 4, system, system_clear_log_file, int(void*))
#define BASE_IDX5 (BASE_IDX4 + 5)
#else
