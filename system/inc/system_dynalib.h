...
DYNALIB_FN(BASE_IDX3 + 4, system, system_get_env_var_bool, int(const char*, bool*, void*))
DYNALIB_FN(BASE_IDX3 + 5, system, system_get_env_var_int, int(const char*, int*, void*))
