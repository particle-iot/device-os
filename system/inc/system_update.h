...
typedef enum
{
    ...
    /**
     * When 0 (default), the system sends a Goodbye message when disconnecting from the cloud.
     * When 1, the system disconnects without sending a notification to the cloud.
     */
    SYSTEM_FLAG_DISABLE_GOODBYE,
