...
enum NcpFWUpdateState {
    ...
    FW_UPDATE_SETUP_QUALIFY_STATE                   = 1,
    ...
    FW_UPDATE_DOWNLOAD_CLOUD_DISCONNECTED_STATE     = 6,
    FW_UPDATE_DOWNLOAD_READY_STATE                  = 7,
    FW_UPDATE_INSTALL_CELL_DISCONNECTING_STATE      = 8,
    FW_UPDATE_INSTALL_STATE_STARTING                = 9,
    FW_UPDATE_INSTALL_STATE_WAITING                 = 10,
    FW_UPDATE_FINISHED_FACTORY_RESET_STATE          = 11,
    FW_UPDATE_FINISHED_POWERING_OFF_STATE           = 12,
    FW_UPDATE_FINISHED_CLOUD_CONNECTING_STATE       = 13,
    FW_UPDATE_FINISHED_CLOUD_CONNECTED_STATE        = 14,
    FW_UPDATE_FINISHED_STATE                        = 15,
};
