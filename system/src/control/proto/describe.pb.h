...
#ifndef PB_PARTICLE_CLOUD_DESCRIBE_PB_H_INCLUDED
#define PB_PARTICLE_CLOUD_DESCRIBE_PB_H_INCLUDED
#include <pb.h>
...
typedef enum _particle_cloud_FirmwareModuleType { 
    ...
    particle_cloud_FirmwareModuleType_BOOTLOADER_MODULE = 1, /* /< Bootloader module */
    particle_cloud_FirmwareModuleType_MONO_FIRMWARE_MODULE = 2, /* /< Monolithic firmware module */
    particle_cloud_FirmwareModuleType_SYSTEM_PART_MODULE = 3, /* /< System part module */
    particle_cloud_FirmwareModuleType_USER_PART_MODULE = 4, /* /< User part module */
    particle_cloud_FirmwareModuleType_NCP_FIRMWARE_MODULE = 5, /* /< NCP firmware module */
    particle_cloud_FirmwareModuleType_RADIO_STACK_MODULE = 6 /* /< Radio stack module */
} particle_cloud_FirmwareModuleType;

/* *
 Firmware module store. */
typedef enum _particle_cloud_FirmwareModuleStore { 
    particle_cloud_FirmwareModuleStore_INVALID_MODULE_STORE = 0, /* /< Invalid */
    particle_cloud_FirmwareModuleStore_MAIN_MODULE_STORE = 1, /* /< Main store */
    particle_cloud_FirmwareModuleStore_FACTORY_MODULE_STORE = 2 /* /< Factory store */
...
#define _particle_cloud_FirmwareModuleType_MAX particle_cloud_FirmwareModuleType_RADIO_STACK_MODULE
#define _particle_cloud_FirmwareModuleType_ARRAYSIZE ((particle_cloud_FirmwareModuleType)(particle_cloud_FirmwareModuleType_RADIO_STACK_MODULE+1))

#define _particle_cloud_FirmwareModuleStore_MIN particle_cloud_FirmwareModuleStore_INVALID_MODULE_STORE
#define _particle_cloud_FirmwareModuleStore_MAX particle_cloud_FirmwareModuleStore_FACTORY_MODULE_STORE
#define _particle_cloud_FirmwareModuleStore_ARRAYSIZE ((particle_cloud_FirmwareModuleStore)(particle_cloud_FirmwareModuleStore_FACTORY_MODULE_STORE+1))
...
#define particle_cloud_FirmwareModule_init_default {_particle_cloud_FirmwareModuleType_MIN, 0, 0, _particle_cloud_FirmwareModuleStore_MIN, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}}
#define particle_cloud_SystemDescribe_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
#define particle_cloud_FirmwareModuleDependency_init_zero {_particle_cloud_FirmwareModuleType_MIN, 0, 0}
#define particle_cloud_FirmwareModule_init_zero  {_particle_cloud_FirmwareModuleType_MIN, 0, 0, _particle_cloud_FirmwareModuleStore_MIN, 0, 0, 0, {{NULL}, NULL}, {{NULL}, NULL}}
#define particle_cloud_SystemDescribe_init_zero  {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
X(a, CALLBACK, SINGULAR, BYTES,    hash,              8) \
...
X(a, CALLBACK, SINGULAR, STRING,   iccid,             3) \
X(a, CALLBACK, SINGULAR, STRING,   modem_firmware_version,   4)
