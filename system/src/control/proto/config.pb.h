...
typedef struct _particle_ctrl_GetDevicePrivateKeyReply {
    pb_callback_t data;
/* @@protoc_insertion_point(struct:particle_ctrl_GetDevicePrivateKeyReply) */
} particle_ctrl_GetDevicePrivateKeyReply;

typedef struct _particle_ctrl_GetDevicePrivateKeyRequest {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_GetDevicePrivateKeyRequest) */
} particle_ctrl_GetDevicePrivateKeyRequest;

typedef struct _particle_ctrl_GetDevicePublicKeyReply {
    pb_callback_t data;
/* @@protoc_insertion_point(struct:particle_ctrl_GetDevicePublicKeyReply) */
} particle_ctrl_GetDevicePublicKeyReply;

typedef struct _particle_ctrl_GetDevicePublicKeyRequest {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_GetDevicePublicKeyRequest) */
} particle_ctrl_GetDevicePublicKeyRequest;
...
typedef struct _particle_ctrl_GetServerPublicKeyReply {
    pb_callback_t data;
/* @@protoc_insertion_point(struct:particle_ctrl_GetServerPublicKeyReply) */
} particle_ctrl_GetServerPublicKeyReply;

typedef struct _particle_ctrl_GetServerPublicKeyRequest {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_GetServerPublicKeyRequest) */
} particle_ctrl_GetServerPublicKeyRequest;
...
typedef struct _particle_ctrl_SetDevicePrivateKeyReply {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_SetDevicePrivateKeyReply) */
} particle_ctrl_SetDevicePrivateKeyReply;

typedef struct _particle_ctrl_SetDevicePrivateKeyRequest {
    pb_callback_t data;
/* @@protoc_insertion_point(struct:particle_ctrl_SetDevicePrivateKeyRequest) */
} particle_ctrl_SetDevicePrivateKeyRequest;
...
typedef struct _particle_ctrl_SetServerPublicKeyReply {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_SetServerPublicKeyReply) */
} particle_ctrl_SetServerPublicKeyReply;

typedef struct _particle_ctrl_SetServerPublicKeyRequest {
    pb_callback_t data;
/* @@protoc_insertion_point(struct:particle_ctrl_SetServerPublicKeyRequest) */
} particle_ctrl_SetServerPublicKeyRequest;
...
typedef struct _particle_ctrl_StartNyanSignalReply {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_StartNyanSignalReply) */
} particle_ctrl_StartNyanSignalReply;

typedef struct _particle_ctrl_StartNyanSignalRequest {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_StartNyanSignalRequest) */
...
typedef struct _particle_ctrl_StopNyanSignalReply {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_StopNyanSignalReply) */
} particle_ctrl_StopNyanSignalReply;

typedef struct _particle_ctrl_StopNyanSignalRequest {
    char dummy_field;
/* @@protoc_insertion_point(struct:particle_ctrl_StopNyanSignalRequest) */
...
#define particle_ctrl_SetServerAddressRequest_init_default {"", 0}
#define particle_ctrl_SetServerAddressReply_init_default {0}
#define particle_ctrl_GetServerAddressRequest_init_default {0}
...
#define particle_ctrl_SetDevicePrivateKeyRequest_init_default {{{NULL}, NULL}}
#define particle_ctrl_SetDevicePrivateKeyReply_init_default {0}
#define particle_ctrl_GetDevicePrivateKeyRequest_init_default {0}
#define particle_ctrl_GetDevicePrivateKeyReply_init_default {{{NULL}, NULL}}
#define particle_ctrl_GetDevicePublicKeyRequest_init_default {0}
#define particle_ctrl_GetDevicePublicKeyReply_init_default {{{NULL}, NULL}}
#define particle_ctrl_SetServerPublicKeyRequest_init_default {{{NULL}, NULL}}
#define particle_ctrl_SetServerPublicKeyReply_init_default {0}
#define particle_ctrl_GetServerPublicKeyRequest_init_default {0}
#define particle_ctrl_GetServerPublicKeyReply_init_default {{{NULL}, NULL}}
...
#define particle_ctrl_SetServerAddressRequest_init_zero {"", 0}
#define particle_ctrl_SetServerAddressReply_init_zero {0}
#define particle_ctrl_GetServerAddressRequest_init_zero {0}
...
#define particle_ctrl_SetDevicePrivateKeyRequest_init_zero {{{NULL}, NULL}}
#define particle_ctrl_SetDevicePrivateKeyReply_init_zero {0}
#define particle_ctrl_GetDevicePrivateKeyRequest_init_zero {0}
#define particle_ctrl_GetDevicePrivateKeyReply_init_zero {{{NULL}, NULL}}
#define particle_ctrl_GetDevicePublicKeyRequest_init_zero {0}
#define particle_ctrl_GetDevicePublicKeyReply_init_zero {{{NULL}, NULL}}
#define particle_ctrl_SetServerPublicKeyRequest_init_zero {{{NULL}, NULL}}
#define particle_ctrl_SetServerPublicKeyReply_init_zero {0}
#define particle_ctrl_GetServerPublicKeyRequest_init_zero {0}
#define particle_ctrl_GetServerPublicKeyReply_init_zero {{{NULL}, NULL}}

/* Field tags (for use in manual encoding/decoding) */
#define particle_ctrl_GetDevicePrivateKeyReply_data_tag 1
#define particle_ctrl_GetDevicePublicKeyReply_data_tag 1
#define particle_ctrl_GetServerPublicKeyReply_data_tag 1
#define particle_ctrl_GetSystemVersionReply_version_tag 1
#define particle_ctrl_SetDevicePrivateKeyRequest_data_tag 1
#define particle_ctrl_SetServerPublicKeyRequest_data_tag 1
...
extern const pb_field_t particle_ctrl_SetServerAddressRequest_fields[3];
extern const pb_field_t particle_ctrl_SetServerAddressReply_fields[1];
extern const pb_field_t particle_ctrl_GetServerAddressRequest_fields[1];
...
extern const pb_field_t particle_ctrl_StartNyanSignalRequest_fields[1];
extern const pb_field_t particle_ctrl_StartNyanSignalReply_fields[1];
extern const pb_field_t particle_ctrl_StopNyanSignalRequest_fields[1];
extern const pb_field_t particle_ctrl_StopNyanSignalReply_fields[1];
extern const pb_field_t particle_ctrl_SetDevicePrivateKeyRequest_fields[2];
extern const pb_field_t particle_ctrl_SetDevicePrivateKeyReply_fields[1];
extern const pb_field_t particle_ctrl_GetDevicePrivateKeyRequest_fields[1];
extern const pb_field_t particle_ctrl_GetDevicePrivateKeyReply_fields[2];
extern const pb_field_t particle_ctrl_GetDevicePublicKeyRequest_fields[1];
extern const pb_field_t particle_ctrl_GetDevicePublicKeyReply_fields[2];
extern const pb_field_t particle_ctrl_SetServerPublicKeyRequest_fields[2];
extern const pb_field_t particle_ctrl_SetServerPublicKeyReply_fields[1];
extern const pb_field_t particle_ctrl_GetServerPublicKeyRequest_fields[1];
extern const pb_field_t particle_ctrl_GetServerPublicKeyReply_fields[2];
...
#define particle_ctrl_SetServerAddressRequest_size 77
#define particle_ctrl_SetServerAddressReply_size 0
#define particle_ctrl_GetServerAddressRequest_size 0
...
/* particle_ctrl_SetDevicePrivateKeyRequest_size depends on runtime parameters */
#define particle_ctrl_SetDevicePrivateKeyReply_size 0
#define particle_ctrl_GetDevicePrivateKeyRequest_size 0
/* particle_ctrl_GetDevicePrivateKeyReply_size depends on runtime parameters */
#define particle_ctrl_GetDevicePublicKeyRequest_size 0
/* particle_ctrl_GetDevicePublicKeyReply_size depends on runtime parameters */
/* particle_ctrl_SetServerPublicKeyRequest_size depends on runtime parameters */
#define particle_ctrl_SetServerPublicKeyReply_size 0
#define particle_ctrl_GetServerPublicKeyRequest_size 0
/* particle_ctrl_GetServerPublicKeyReply_size depends on runtime parameters */
