...
#define particle_ctrl_mesh_NetworkInfo_init_default {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
#define particle_ctrl_mesh_AuthRequest_init_default {{{NULL}, NULL}}
#define particle_ctrl_mesh_AuthReply_init_default {0}
#define particle_ctrl_mesh_CreateNetworkRequest_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define particle_ctrl_mesh_AddJoinerRequest_init_default {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define particle_ctrl_mesh_NetworkInfo_init_zero {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
#define particle_ctrl_mesh_AuthRequest_init_zero {{{NULL}, NULL}}
#define particle_ctrl_mesh_AuthReply_init_zero   {0}
#define particle_ctrl_mesh_CreateNetworkRequest_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define particle_ctrl_mesh_AddJoinerRequest_init_zero {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define particle_ctrl_mesh_NetworkInfo_ext_pan_tag 2
#define particle_ctrl_mesh_NetworkInfo_pan_tag   3
...
extern const pb_field_t particle_ctrl_mesh_CreateNetworkRequest_fields[3];
extern const pb_field_t particle_ctrl_mesh_CreateNetworkReply_fields[2];
extern const pb_field_t particle_ctrl_mesh_StartCommissionerRequest_fields[1];
...
extern const pb_field_t particle_ctrl_mesh_AddJoinerRequest_fields[3];
...
#define particle_ctrl_mesh_StartCommissionerRequest_size 0
