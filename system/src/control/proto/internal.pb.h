...
#define particle_firmware_WifiConfig_Network_init_default {{{NULL}, NULL}, {0, {0}}, _particle_ctrl_wifi_Security_MIN, false, particle_ctrl_wifi_Credentials_init_default}
#define particle_firmware_CellularConfig_init_default {false, particle_ctrl_cellular_AccessPoint_init_default, false, particle_ctrl_cellular_AccessPoint_init_default, _particle_ctrl_cellular_SimType_MIN}
#define particle_firmware_WifiConfig_init_zero   {{{NULL}, NULL}}
#define particle_firmware_WifiConfig_Network_init_zero {{{NULL}, NULL}, {0, {0}}, _particle_ctrl_wifi_Security_MIN, false, particle_ctrl_wifi_Credentials_init_zero}
#define particle_firmware_CellularConfig_init_zero {false, particle_ctrl_cellular_AccessPoint_init_zero, false, particle_ctrl_cellular_AccessPoint_init_zero, _particle_ctrl_cellular_SimType_MIN}
...
X(a, STATIC,   OPTIONAL, MESSAGE,  internal_sim,      1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  external_sim,      2) \
