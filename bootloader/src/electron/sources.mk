...
CSRC += $(call target_files_rel,$(BOOTLOADER_MODULE_PATH)/../hal/src/electron/,watchdog_hal.c)
CPPSRC += $(call target_files_rel,$(BOOTLOADER_MODULE_PATH)/../hal/src/electron/,dct_hal.cpp)
CPPSRC += $(call target_files_rel,$(BOOTLOADER_MODULE_PATH)/../hal/src/stm32/,newlib.cpp)
