BOOTLOADER_SRC_COREV2_PATH = $(BOOTLOADER_MODULE_PATH)/src/duo
...
LDFLAGS += -L$(PROJECT_ROOT)/modules/duo/user-part
LINKER_DEPS += $(PROJECT_ROOT)/modules/duo/user-part/module_user_memory.ld
