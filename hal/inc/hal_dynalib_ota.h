...
DYNALIB_FN(7, hal_ota, HAL_FLASH_End, hal_update_complete_t(uint32_t, uint32_t, hal_module_t*))
DYNALIB_FN(8, hal_ota, HAL_FLASH_OTA_Validate, int(uint32_t, uint32_t, hal_module_t*, bool, module_validation_flags_t, void*))
