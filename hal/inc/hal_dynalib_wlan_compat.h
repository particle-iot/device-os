...
#ifndef HAL_DYNALIB_WLAN_COMPAT_H
#define	HAL_DYNALIB_WLAN_COMPAT_H
...
DYNALIB_FN(33, hal_wlan, wlan_set_country_code, int(wlan_country_code_t, const void*))
DYNALIB_FN(34, hal_wlan, wlan_get_country_code, wlan_country_code_t(void*))
DYNALIB_END(hal_wlan)

#endif // HAL_PLATFORM_WIFI

#endif	/* HAL_DYNALIB_WLAN_COMPAT_H */
