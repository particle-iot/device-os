...
#ifndef HAL_INCREASE_CHARGING_CURRENT_WHEN_POWERED_BY_VUSB
#define HAL_INCREASE_CHARGING_CURRENT_WHEN_POWERED_BY_VUSB (0)
#endif // HAL_INCREASE_CHARGING_CURRENT_WHEN_POWERED_BY_VUSB
