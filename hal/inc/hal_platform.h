...
#ifndef HAL_PLATFORM_ETHERNET_FEATHERWING_SPI_CLOCKDIV
#define HAL_PLATFORM_ETHERNET_FEATHERWING_SPI_CLOCKDIV 2
#endif /* HAL_PLATFORM_ETHERNET_FEATHERWING_SPI_CLOCKDIV */
