...
DYNALIB_FN( PERIPH_CENTRAL_BASE_IDX + 0,  hal_ble, ble_gap_connect, int(const hal_ble_addr_t*, const hal_ble_conn_params_t*, void*) )
DYNALIB_FN( PERIPH_CENTRAL_BASE_IDX + 1,  hal_ble, ble_gap_is_connecting, bool(void) )
DYNALIB_FN( PERIPH_CENTRAL_BASE_IDX + 2,  hal_ble, ble_gap_is_connected, bool(void) )
...
DYNALIB_FN( PERIPH_CENTRAL_BASE_IDX + 6,  hal_ble, ble_gap_get_rssi, int(uint16_t, void*) )
#define GATTS_BASE_IDX (PERIPH_CENTRAL_BASE_IDX + 7)
...
DYNALIB_FN( GATTS_BASE_IDX + 3,  hal_ble, ble_gatt_server_set_characteristic_value, int(uint16_t, const uint8_t*, uint16_t, void*) )
DYNALIB_FN( GATTS_BASE_IDX + 4,  hal_ble, ble_gatt_server_get_characteristic_value, int(uint16_t, uint8_t*, uint16_t*, void*) )
DYNALIB_FN( GATTS_BASE_IDX + 5,  hal_ble, ble_gatt_server_notify_characteristic_value, int(uint16_t, uint16_t, const uint8_t*, uint16_t, void*) )
DYNALIB_FN( GATTS_BASE_IDX + 6,  hal_ble, ble_gatt_server_indicate_characteristic_value, int(uint16_t, uint16_t, const uint8_t*, uint16_t, void*) )
#define GATTC_BASE_IDX (GATTS_BASE_IDX + 7)
...
DYNALIB_FN( GATTC_BASE_IDX + 7,  hal_ble, ble_gatt_client_write_with_response, int(uint16_t, uint16_t, const uint8_t*, uint16_t, void*) )
DYNALIB_FN( GATTC_BASE_IDX + 8,  hal_ble, ble_gatt_client_write_without_response, int(uint16_t, uint16_t, const uint8_t*, uint16_t, void*) )
DYNALIB_FN( GATTC_BASE_IDX + 9,  hal_ble, ble_gatt_client_read, int(uint16_t, uint16_t, uint8_t*, uint16_t*, void*) )
