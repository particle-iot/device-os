...
DYNALIB_FN(38, hal_ble, ble_gatt_server_notify_characteristic_value, int(uint16_t, uint16_t, const uint8_t*, uint16_t, void*))
DYNALIB_FN(39, hal_ble, ble_gatt_server_indicate_characteristic_value, int(uint16_t, uint16_t, const uint8_t*, uint16_t, void*))
