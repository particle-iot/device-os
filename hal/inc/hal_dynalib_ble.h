...
DYNALIB_FN( 0,  hal_ble, ble_stack_init, int(void*) )
DYNALIB_FN( 1,  hal_ble, ble_select_antenna, int(hal_ble_ant_type_t) )
DYNALIB_FN( 2,  hal_ble, ble_set_callback_on_events, int(on_ble_evt_cb_t, void*) )
DYNALIB_FN( 3,  hal_ble, ble_gap_set_device_address, int(const hal_ble_addr_t*) )
DYNALIB_FN( 4,  hal_ble, ble_gap_get_device_address, int(hal_ble_addr_t*) )
DYNALIB_FN( 5,  hal_ble, ble_gap_set_device_name, int(const uint8_t*, uint16_t) )
DYNALIB_FN( 6,  hal_ble, ble_gap_get_device_name, int(uint8_t*, uint16_t*) )
DYNALIB_FN( 7,  hal_ble, ble_gap_set_appearance, int(uint16_t) )
DYNALIB_FN( 8,  hal_ble, ble_gap_get_appearance, int(uint16_t*) )
DYNALIB_FN( 9, hal_ble, ble_gap_set_ppcp, int(const hal_ble_conn_params_t*, void*) )
DYNALIB_FN( 10, hal_ble, ble_gap_get_ppcp, int(hal_ble_conn_params_t*, void*) )
DYNALIB_FN( 11, hal_ble, ble_gap_add_whitelist, int(const hal_ble_addr_t*, uint8_t, void*) )
DYNALIB_FN( 12, hal_ble, ble_gap_delete_whitelist, int(void*) )
#define BROADCASTER_BASE_IDX 13
...
DYNALIB_FN( OBSERVER_BASE_IDX + 2,  hal_ble, ble_gap_start_scan, int(on_ble_scan_result_cb_t, void*, void*) )
...
DYNALIB_FN( GATTC_BASE_IDX + 0,  hal_ble, ble_gatt_client_discover_all_services, int(uint16_t, on_ble_disc_service_cb_t, void*, void*) )
DYNALIB_FN( GATTC_BASE_IDX + 1,  hal_ble, ble_gatt_client_discover_service_by_uuid, int(uint16_t, const hal_ble_uuid_t*, on_ble_disc_service_cb_t, void*, void*) )
