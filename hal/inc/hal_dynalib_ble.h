...
DYNALIB_FN( GATTC_BASE_IDX + 2,  hal_ble, ble_gatt_client_discover_characteristics, int(uint16_t, const hal_ble_svc_t*, void*))
DYNALIB_FN( GATTC_BASE_IDX + 3,  hal_ble, ble_gatt_client_discover_characteristics_by_uuid, int(uint16_t, const hal_ble_svc_t*, const hal_ble_uuid_t*, void*) )
