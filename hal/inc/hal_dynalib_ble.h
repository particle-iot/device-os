...
DYNALIB_FN(1, hal_ble, hal_ble_select_antenna, int(hal_ble_ant_type_t, void*))
DYNALIB_FN(2, hal_ble, hal_ble_set_callback_on_events, int(on_ble_evt_cb_t, void*, void*))
DYNALIB_FN(3, hal_ble, hal_ble_gap_set_device_address, int(const hal_ble_addr_t*, void*))
DYNALIB_FN(4, hal_ble, hal_ble_gap_get_device_address, int(hal_ble_addr_t*, void*))
DYNALIB_FN(5, hal_ble, hal_ble_gap_set_device_name, int(const char*, size_t, void*))
DYNALIB_FN(6, hal_ble, hal_ble_gap_get_device_name, int(char*, size_t, void*))
DYNALIB_FN(7, hal_ble, hal_ble_gap_set_appearance, int(ble_sig_appearance_t, void*))
DYNALIB_FN(8, hal_ble, hal_ble_gap_get_appearance, int(ble_sig_appearance_t*, void*))
...
DYNALIB_FN(13, hal_ble, hal_ble_gap_set_tx_power, int(int8_t, void*))
...
DYNALIB_FN(32, hal_ble, hal_ble_gap_is_connecting, bool(const hal_ble_addr_t*, void*))
DYNALIB_FN(33, hal_ble, hal_ble_gap_is_connected, bool(const hal_ble_addr_t*, void*))
DYNALIB_FN(34, hal_ble, hal_ble_gap_connect_cancel, int(const hal_ble_addr_t*, void*))
