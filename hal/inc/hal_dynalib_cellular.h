...
#define BASE_IDX 36 // Base index for all subsequent functions
...
#define BASE_IDX 37 // Base index for all subsequent functions
#endif // !HAL_PLATFORM_MESH

DYNALIB_FN(BASE_IDX + 0, hal_cellular, cellular_global_identity, cellular_result_t(CellularGlobalIdentity*, void*))
