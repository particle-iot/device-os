...
DYNALIB_FN(31, hal_cellular, cellular_at_response_handler_set, cellular_result_t(_CELLULAR_LOGGER_CB_MDM cb, void* data, void* reserved))
DYNALIB_FN(32, hal_cellular, cellular_urcs_get, cellular_result_t(void* reserved))
