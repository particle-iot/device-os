...
// DYNALIB_FN(25, hal_posix_syscall, _execve, int(const char* filename, char* const argv[], char* const envp[]))
// DYNALIB_FN(26, hal_posix_syscall, _fork, pid_t(void))
// DYNALIB_FN(27, hal_posix_syscall, _getpid, pid_t(void))
// DYNALIB_FN(28, hal_posix_syscall, _gettimeofday, int(struct timeval* tv, void* tz))
// DYNALIB_FN(29, hal_posix_syscall, _kill, int(pid_t pid, int sig))
// DYNALIB_FN(30, hal_posix_syscall, _sbrk, void*(intptr_t increment))
// DYNALIB_FN(31, hal_posix_syscall, _times, clock_t(struct tms* buf))
// DYNALIB_FN(32, hal_posix_syscall, _wait, pid_t(int* status))
