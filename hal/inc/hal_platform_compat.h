...
#if PLATFORM_ID==PLATFORM_P1 || PLATFORM_ID==PLATFORM_PHOTON_PRODUCTION || PLATFORM_ID==PLATFORM_PHOTON_DEV
#define HAL_PLATFORM_WICED (1)
#endif
...
#if HAL_PLATFORM_WICED
#define HAL_PLATFORM_SOFTAP_SETUP (1)
#endif

#if PLATFORM_ID==10 || PLATFORM_ID==3 || HAL_PLATFORM_WICED
