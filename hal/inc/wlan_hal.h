...
#define DUMP_STATE() do { \
    ...
    DEBUG("\r\nPARTICLE_WLAN_RESET=%d\r\nPARTICLE_WLAN_SLEEP=%d\r\nPARTICLE_WLAN_STARTED=%d\r\nPARTICLE_CLOUD_CONNECT=%d", \
           PARTICLE_WLAN_RESET,PARTICLE_WLAN_SLEEP,PARTICLE_WLAN_STARTED,PARTICLE_CLOUD_CONNECT); \
    DEBUG("\r\nPARTICLE_CLOUD_SOCKETED=%d\r\nPARTICLE_CLOUD_CONNECTED=%d\r\nPARTICLE_FLASH_UPDATE=%d\r\nPARTICLE_LED_FADE=%d\r\n", \
           PARTICLE_CLOUD_SOCKETED,PARTICLE_CLOUD_CONNECTED,PARTICLE_FLASH_UPDATE,PARTICLE_LED_FADE); \
 } while(0)
