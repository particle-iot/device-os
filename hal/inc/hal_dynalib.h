...
DYNALIB_USER_FN(hal,HAL_ADC_Read)
...
DYNALIB_USER_FN(hal,HAL_DAC_Write)
DYNALIB_FN(hal,HAL_Delay_Milliseconds)
DYNALIB_FN(hal,HAL_Delay_Microseconds)
DYNALIB_FN(hal,HAL_device_ID)

DYNALIB_USER_FN(hal,HAL_EEPROM_Init)
DYNALIB_USER_FN(hal,HAL_EEPROM_Read)
DYNALIB_USER_FN(hal,HAL_EEPROM_Write)
DYNALIB_USER_FN(hal,HAL_EEPROM_Length)

DYNALIB_FN(hal,HAL_Validate_Pin_Function)
DYNALIB_FN(hal,HAL_Pin_Mode)
DYNALIB_FN(hal,HAL_Get_Pin_Mode)
DYNALIB_FN(hal,HAL_GPIO_Write)
DYNALIB_FN(hal,HAL_GPIO_Read)

DYNALIB_USER_FN(hal,HAL_I2C_Set_Speed)
DYNALIB_USER_FN(hal,HAL_I2C_Enable_DMA_Mode)
DYNALIB_USER_FN(hal,HAL_I2C_Stretch_Clock)
DYNALIB_USER_FN(hal,HAL_I2C_Begin)
DYNALIB_USER_FN(hal,HAL_I2C_End)
DYNALIB_USER_FN(hal,HAL_I2C_Request_Data)
DYNALIB_USER_FN(hal,HAL_I2C_Begin_Transmission)
DYNALIB_USER_FN(hal,HAL_I2C_End_Transmission)
DYNALIB_USER_FN(hal,HAL_I2C_Write_Data)
DYNALIB_USER_FN(hal,HAL_I2C_Available_Data)
DYNALIB_USER_FN(hal,HAL_I2C_Read_Data)
DYNALIB_USER_FN(hal,HAL_I2C_Peek_Data)
DYNALIB_USER_FN(hal,HAL_I2C_Flush_Data)
DYNALIB_USER_FN(hal,HAL_I2C_Is_Enabled)
DYNALIB_USER_FN(hal,HAL_I2C_Set_Callback_On_Receive)
DYNALIB_USER_FN(hal,HAL_I2C_Set_Callback_On_Request)
DYNALIB_FN_PLACEHOLDER(hal)
DYNALIB_FN_PLACEHOLDER(hal)
        
DYNALIB_FN(hal,inet_gethostbyname)

DYNALIB_USER_FN(hal,HAL_Interrupts_Attach)
DYNALIB_USER_FN(hal,HAL_Interrupts_Detach)
DYNALIB_USER_FN(hal,HAL_Interrupts_Enable_All)
DYNALIB_USER_FN(hal,HAL_Interrupts_Disable_All)
...
DYNALIB_USER_FN(hal,HAL_PWM_Write)
DYNALIB_USER_FN(hal,HAL_PWM_Get_Frequency)
DYNALIB_USER_FN(hal,HAL_PWM_Get_AnalogValue)
...
DYNALIB_USER_FN(hal,HAL_Servo_Attach)
DYNALIB_USER_FN(hal,HAL_Servo_Detach)
DYNALIB_USER_FN(hal,HAL_Servo_Write_Pulse_Width)
DYNALIB_USER_FN(hal,HAL_Servo_Read_Pulse_Width)
DYNALIB_USER_FN(hal,HAL_Servo_Read_Frequency)        
...
DYNALIB_USER_FN(hal,HAL_SPI_Begin)
DYNALIB_USER_FN(hal,HAL_SPI_End)
DYNALIB_USER_FN(hal,HAL_SPI_Set_Bit_Order)
DYNALIB_USER_FN(hal,HAL_SPI_Set_Data_Mode)
DYNALIB_USER_FN(hal,HAL_SPI_Set_Clock_Divider)
DYNALIB_USER_FN(hal,HAL_SPI_Send_Receive_Data)
DYNALIB_USER_FN(hal,HAL_SPI_Is_Enabled)
...
DYNALIB_USER_FN(hal,HAL_Tone_Start)
DYNALIB_USER_FN(hal,HAL_Tone_Stop)
DYNALIB_USER_FN(hal,HAL_Tone_Get_Frequency)
DYNALIB_USER_FN(hal,HAL_Tone_Is_Stopped)
        
DYNALIB_USER_FN(hal,HAL_USART_Init)
DYNALIB_USER_FN(hal,HAL_USART_Begin)
DYNALIB_USER_FN(hal,HAL_USART_End)
DYNALIB_USER_FN(hal,HAL_USART_Write_Data)
DYNALIB_USER_FN(hal,HAL_USART_Available_Data)
DYNALIB_USER_FN(hal,HAL_USART_Read_Data)
DYNALIB_USER_FN(hal,HAL_USART_Peek_Data)
