...
int SaraNcpClient::selectSimCard(ModemState& state) {
    ...
    if (attempts != 0 && (ncpId() == PLATFORM_NCP_SARA_R410 || ncpId() == PLATFORM_NCP_SARA_R510)) {
    ...
    if (ncpId() == PLATFORM_NCP_SARA_R410 || ncpId() == PLATFORM_NCP_SARA_R510) {
        ...
        do {
            ...
            if (r == 1 && (static_cast<UbloxSaraUmnoprof>(curProf) == UbloxSaraUmnoprof::SW_DEFAULT ||
                    ...
                    static_cast<UbloxSaraUmnoprof>(curProf) != UbloxSaraUmnoprof::STANDARD_EUROPE)) ) {
                int newProf = static_cast<int>(UbloxSaraUmnoprof::STANDARD_EUROPE);
                // TWILIO Super SIM
                ...
                if ((netConf_.netProv() == CellularNetworkProvider::TWILIO ||
                    netConf_.netProv() == CellularNetworkProvider::KORE_ATT) && retBand == 1) {
...
int SaraNcpClient::waitAtResponseFromPowerOn(ModemState& modemState) {
    ...
    unsigned int defaultBaudrate = (ncpId() != PLATFORM_NCP_SARA_R410 && ncpId() != PLATFORM_NCP_SARA_R510) ?
