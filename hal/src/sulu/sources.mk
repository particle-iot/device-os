HAL_SRC_SULU_PATH = $(TARGET_HAL_PATH)/src/sulu

INCLUDE_DIRS += $(HAL_SRC_SULU_PATH)

CSRC += $(call target_files,$(HAL_SRC_SULU_PATH)/,*.c)
CPPSRC += $(call target_files,$(HAL_SRC_SULU_PATH)/,*.cpp)
