...
/* P2_CELL_STATUS- 30 */ { MCP23S17_PORT_A, 3,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
/* GNSS_GEOFENCE - 31 */ { MCP23S17_PORT_A, 4,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
...
/* CAN_VDD_EN    - 35 */ { MCP23S17_PORT_B, 0,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
/* CAN_STBY      - 36 */ { MCP23S17_PORT_B, 1,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
/* CAN_INT       - 37 */ { MCP23S17_PORT_B, 2,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
/* P2_CELL_PWR   - 38 */ { MCP23S17_PORT_B, 3,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
...
/* SENSOR_INT1   - 40 */ { MCP23S17_PORT_B, 5,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
/* SHT_ALERT     - 41 */ { MCP23S17_PORT_B, 6,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},
/* IO_2V8_EN     - 42 */ { MCP23S17_PORT_B, 7,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_IO_EXPANDER, 0},

/* IOE_RST       - 43 */ { DEMUX_PORT,      1,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_DEMUX, 0},
/* SENSOR_CS     - 44 */ { DEMUX_PORT,      2,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_DEMUX, 0},
/* IOE_CS        - 45 */ { DEMUX_PORT,      5,  PIN_MODE_NONE, PF_NONE, ADC_CHANNEL_NONE, PWM_INSTANCE_NONE, PWM_CHANNEL_NONE, HAL_PIN_TYPE_DEMUX, 0},
