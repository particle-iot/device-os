HAL_SRC_TRACKERM_PATH = $(TARGET_HAL_PATH)/src/trackerm

INCLUDE_DIRS += $(HAL_SRC_TRACKERM_PATH)

CSRC += $(call target_files,$(HAL_SRC_TRACKERM_PATH)/,*.c)
CPPSRC += $(call target_files,$(HAL_SRC_TRACKERM_PATH)/,*.cpp)
