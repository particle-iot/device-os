...
class SaraR4NcpClient: public CellularNcpClient {
public:
    SaraR4NcpClient();
    ~SaraR4NcpClient();
...
inline AtParser* SaraR4NcpClient::atParser() {
    return &parser_;
}

inline void SaraR4NcpClient::lock() {
    mutex_.lock();
}

inline void SaraR4NcpClient::unlock() {
    mutex_.unlock();
}
