...
#define HAL_PLATFORM_USB_PRODUCT_STRING "M-SoM"
#else
#define HAL_PLATFORM_USB_PRODUCT_STRING "M-SoM DFU Mode"
...
#define HAL_PLATFORM_PPP_SERVER_USART_FLAGS (SERIAL_8N1 | SERIAL_FLOW_CONTROL_RTS_CTS)

#define HAL_PLATFORM_PPP_SERVER_USB (0)
