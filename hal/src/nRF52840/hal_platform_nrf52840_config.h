...
#define HAL_PLATFORM_PPP_TX_QUEUE_SIZE (4)
...
#define HAL_PLATFORM_INCLUDE_LEGACY_MODULE_INFO (1)
#endif

#if PLATFORM_ID == PLATFORM_ARGON
# define HAL_PLATFORM_USB_PRODUCT_STRING              "Argon"
#elif PLATFORM_ID == PLATFORM_BORON
# define HAL_PLATFORM_USB_PRODUCT_STRING              "Boron"
#elif PLATFORM_ID == PLATFORM_ESOMX
# define HAL_PLATFORM_USB_PRODUCT_STRING              "E-SoM-X"
#elif PLATFORM_ID == PLATFORM_ASOM
# define HAL_PLATFORM_USB_PRODUCT_STRING              "A-SoM"
#elif PLATFORM_ID == PLATFORM_BSOM
# define HAL_PLATFORM_USB_PRODUCT_STRING              "B-SoM"
#elif PLATFORM_ID == PLATFORM_B5SOM
# define HAL_PLATFORM_USB_PRODUCT_STRING              "B5-SoM"
#elif PLATFORM_ID == PLATFORM_TRACKER
# define HAL_PLATFORM_USB_PRODUCT_STRING              "Tracker"
#elif PLATFORM_ID == PLATFORM_ELECTRON2
# define HAL_PLATFORM_USB_PRODUCT_STRING              "Electron 2"
#endif
...
#endif // MODULE_FUNCTION == 2

#define HAL_PLATFORM_ASSERT_EXCLUDE_FILE_INFO (1)
