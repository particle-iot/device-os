...
#define PPP_SUPPORT                     (PLATFORM_ID == PLATFORM_BORON || PLATFORM_ID == PLATFORM_ESOMX || PLATFORM_ID == PLATFORM_BSOM || PLATFORM_ID == PLATFORM_B5SOM || PLATFORM_ID == PLATFORM_TRACKER || PLATFORM_ID == PLATFORM_ELECTRON2)
