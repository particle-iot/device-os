 ...
 */
// The current value of 1152 bytes is chosen so that a CoAP message of that
// size would fit into a 1280-byte IPv4 or IPv6 packet, and there would still
// be some space left for DTLS extensions. IPv6 mandates a minimum MTU of 1280
// bytes, and we consider the chance of fragmentation of a 1280-byte packet to
// be minimal in IPv4 networks.
//
// Encrypted application data: 1152 bytes;
