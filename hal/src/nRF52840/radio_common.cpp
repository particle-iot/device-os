...
#elif PLATFORM_ID != PLATFORM_ASOM && PLATFORM_ID != PLATFORM_BSOM && PLATFORM_ID != PLATFORM_XSOM && PLATFORM_ID != PLATFORM_B5SOM
#error "Unsupported platform"
#endif
    return 0;
}
...
int selectAntenna(radio_antenna_type antenna) {
    ...
    case RADIO_ANT_INTERNAL: {
        ...
        LOG(TRACE, "Using internal BLE/mesh antenna");
        break;
    }
#endif
#if HAL_PLATFORM_RADIO_ANTENNA_EXTERNAL
    case RADIO_ANT_EXTERNAL: {
        ...
        LOG(TRACE, "Using external BLE/mesh antenna");
        break;
    }
#endif
    default:
