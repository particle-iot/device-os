 ...
 * \ingroup QueueManagement
 */
signed portBASE_TYPE xQueueGenericSend( xQueueHandle xQueue, /*@null@*/ const void * const pvItemToQueue, portTickType xTicksToWait, portBASE_TYPE xCopyPosition ) PRIVILEGED_FUNCTION;
 ...
 * \ingroup QueueManagement
 */
signed portBASE_TYPE xQueueGenericReceive( xQueueHandle xQueue, /*@null@*/ /*@out@*/ const void * const pvBuffer, portTickType xTicksToWait, portBASE_TYPE xJustPeek ) PRIVILEGED_FUNCTION /*@modifies internalState@*/;
 ...
 * \ingroup QueueManagement
 */
void vQueueDelete( /*@only@*/ xQueueHandle xQueue ) PRIVILEGED_FUNCTION;
 ...
 * \ingroup QueueManagement
 */
signed portBASE_TYPE xQueueGenericSendFromISR( xQueueHandle xQueue, /*@null@*/ const void * const pvItemToQueue, /*@out@*/ signed portBASE_TYPE *pxHigherPriorityTaskWoken, portBASE_TYPE xCopyPosition ) PRIVILEGED_FUNCTION;
 ...
 */
/*@null@*/ /*@out@*/ /*@only@*/ xQueueHandle xQueueGenericCreate( unsigned portBASE_TYPE uxQueueLength, unsigned portBASE_TYPE uxItemSize, unsigned char ucQueueType ) PRIVILEGED_FUNCTION  /*@defines *result@*/;
