 ...
 * \ingroup Tasks
 */
void vTaskDelete( /*@null@*/ xTaskHandle xTaskToDelete ) PRIVILEGED_FUNCTION;
 ...
 */
signed portBASE_TYPE xTaskGenericCreate( pdTASK_CODE pxTaskCode, const signed char * const pcName, unsigned short usStackDepth, /*@null@*/ void *pvParameters, unsigned portBASE_TYPE uxPriority, /*@out@*/ xTaskHandle *pxCreatedTask, /*@null@*/ portSTACK_TYPE *puxStackBuffer, /*@null@*/ const xMemoryRegion * const xRegions ) PRIVILEGED_FUNCTION;
