...
typedef enum PlatformNCPIdentifier {
    ...
    PLATFORM_NCP_QUECTEL_EG916Q_GL = PLATFORM_NCP_IDENTIFIER(PLATFORM_NCP_MANUFACTURER_QUECTEL, 14),
    PLATFORM_NCP_QUECTEL_EG800Q_GL = PLATFORM_NCP_IDENTIFIER(PLATFORM_NCP_MANUFACTURER_QUECTEL, 15),
