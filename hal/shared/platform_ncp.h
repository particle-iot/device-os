...
enum MeshNCPManufacturer {
    ...
    MESH_NCP_MANUFACTURER_BROADCOM = 4
};
...
enum MeshNCPIdentifier {
    ...
    MESH_NCP_SARA_U260 = MESH_NCP_IDENTIFIER(MESH_NCP_MANUFACTURER_UBLOX, 7),
    MESH_NCP_SARA_U270 = MESH_NCP_IDENTIFIER(MESH_NCP_MANUFACTURER_UBLOX, 8),
    MESH_NCP_BROADCOM_BCM9WCDUSI09 = MESH_NCP_IDENTIFIER(MESH_NCP_MANUFACTURER_BROADCOM, 9),
    MESH_NCP_BROADCOM_BCM9WCDUSI14 = MESH_NCP_IDENTIFIER(MESH_NCP_MANUFACTURER_BROADCOM, 10)
};
