# This is specific to the duo. Include the WICED WIFI
WIFI_MODULE_WICED_LIB_FILES = $(HAL_LIB_COREV2)/resources.a $(HAL_LIB_DIR)/src/duo/resources.o $(HAL_LIB_COREV2)/FreeRTOS/STM32F2xx.a
# if !USE_MBEDTLS
