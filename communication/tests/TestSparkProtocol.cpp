...
SUITE(ParticleProtocolConstruction)
{
  TEST_FIXTURE(ConstructorFixture, NoErrorReturnedFromHandshake)
  {
    int err = particle_protocol.handshake();
    CHECK_EQUAL(0, err);
  }
  ...
  TEST_FIXTURE(ConstructorFixture, BlockingSendAccumulatesOverMultipleCalls)
  {
    ...
    particle_protocol.blocking_send(expected, 20);
  ...
  TEST_FIXTURE(ConstructorFixture, BlockingReceiveAccumulatesOverMultipleCalls)
  {
    ...
    particle_protocol.blocking_receive(receive_buf, 20);
  ...
  SUITE(EventLoopEventHandlers)
  {
    TEST_FIXTURE(ConstructorFixture, EventLoopCallsOnlyHandlerOnExactlyMatchedEvent)
    {
      ...
      particle_protocol.add_event_handler(event_name, mock_event_handler_0);
      particle_protocol.event_loop();
    ...
    TEST_FIXTURE(ConstructorFixture, EventLoopCallsFirstHandlerOnMatchedEvent)
    {
      ...
      particle_protocol.add_event_handler(event_name, mock_event_handler_0);
      particle_protocol.add_event_handler("foo", mock_event_handler_1);
      particle_protocol.event_loop();
      CHECK_ARRAY_EQUAL(event_name, event_handlers_called_with[0].event_name, strlen(event_name));
    }
    ...
    TEST_FIXTURE(ConstructorFixture, EventLoopCallsSecondHandlerOnMatchedEvent)
    {
      ...
      particle_protocol.add_event_handler("foo", mock_event_handler_0);
      particle_protocol.add_event_handler(event_name, mock_event_handler_1);
      particle_protocol.event_loop();
    ...
    TEST_FIXTURE(ConstructorFixture, EventLoopDoesNotCallHandlerOnEventNameShorterThanFilter)
    {
      ...
      particle_protocol.add_event_handler("teapot-boiled-over", mock_event_handler_0);
      particle_protocol.event_loop();
    ...
    TEST_FIXTURE(ConstructorFixture, EventLoopParsesMaxAgeOptionOnMatchedEvent)
    {
      ...
      particle_protocol.add_event_handler("teacup", mock_event_handler_0);
      particle_protocol.event_loop();
    ...
    TEST_FIXTURE(ConstructorFixture, EventLoopCallsHandlerWithMultiPathName)
    {
      ...
      particle_protocol.add_event_handler("a", mock_event_handler_0);
      particle_protocol.event_loop();
    ...
    TEST_FIXTURE(ConstructorFixture, EventLoopCallsHandlerWithLongMultiPathName)
    {
      ...
      particle_protocol.add_event_handler("a/long-coap-option", mock_event_handler_0);
      particle_protocol.event_loop();
  ...
  TEST(IsInitializedIsFalse)
  {
    ...
    CHECK_EQUAL(false, particle_protocol.is_initialized());
  }

  TEST_FIXTURE(ConstructorFixture, AfterInitIsInitializedIsTrue)
  {
    CHECK_EQUAL(true, particle_protocol.is_initialized());
  }
  ...
  TEST_FIXTURE(ConstructorFixture, EventMatchesOpenSSL)
  {
    ...
    particle_protocol.handshake();
    bytes_received[0] = bytes_sent[0] = 0;
    particle_protocol.send_event("motion-detected", NULL, 60, EventType::PUBLIC);
  ...
  TEST_FIXTURE(ConstructorFixture, EventWithDataMatchesOpenSSL)
  {
    ...
    particle_protocol.handshake();
    bytes_received[0] = bytes_sent[0] = 0;
    particle_protocol.send_event("lake-depth/1", "28m", 21600, EventType::PRIVATE);
    CHECK_ARRAY_EQUAL(expected, sent_buf_0, 34);
  }
  ...
  TEST_FIXTURE(ConstructorFixture, SubscribeToDeviceMatchesOpenSSL)
  {
    ...
    particle_protocol.handshake();
    bytes_received[0] = bytes_sent[0] = 0;
    particle_protocol.send_subscription(NULL, "53ff73065067544816300187");
    CHECK_ARRAY_EQUAL(expected, sent_buf_0, 34);
  }
  ...
  TEST_FIXTURE(ConstructorFixture, SubscribeToMyDevicesFilteredMatchesOpenSSL)
  {
    ...
    particle_protocol.handshake();
    bytes_received[0] = bytes_sent[0] = 0;
    particle_protocol.send_subscription("motion/open", SubscriptionScope::MY_DEVICES);
    CHECK_ARRAY_EQUAL(expected, sent_buf_0, 34);
  }
  ...
  TEST_FIXTURE(ConstructorFixture, SubscribeToFirehoseWithMaxLenFilterMatchesOpenSSL)
  {
    ...
    particle_protocol.handshake();
    bytes_received[0] = bytes_sent[0] = 0;
    particle_protocol.send_subscription(
  ...
  TEST_FIXTURE(ConstructorFixture, PublishingBurst4EventsSucceeds)
  {
    bool success[4];
    next_millis = 1000;
    success[0] = particle_protocol.send_event("a", NULL, 60, EventType::PUBLIC);
    success[1] = particle_protocol.send_event("b", NULL, 60, EventType::PUBLIC);
    success[2] = particle_protocol.send_event("c", NULL, 60, EventType::PUBLIC);
    success[3] = particle_protocol.send_event("d", NULL, 60, EventType::PUBLIC);
  ...
  TEST_FIXTURE(ConstructorFixture, PublishingBurst5EventsFails)
  {
    ...
    success[2] = particle_protocol.send_event("c", NULL, 60, EventType::PUBLIC);
    success[3] = particle_protocol.send_event("d", NULL, 60, EventType::PUBLIC);
    success[4] = particle_protocol.send_event("e", NULL, 60, EventType::PUBLIC);
  ...
  TEST_FIXTURE(ConstructorFixture, TimeRequestMatchesOpenSSL)
  {
    ...
    particle_protocol.handshake();
    bytes_received[0] = bytes_sent[0] = 0;
    particle_protocol.send_time_request();
    CHECK_ARRAY_EQUAL(expected, sent_buf_0, 18);
  }
}
