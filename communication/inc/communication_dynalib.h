...
DYNALIB_FN(BASE_IDX2 + 9, communication, spark_protocol_begin_event, int(ProtocolFacade*, int, const char*, int, int, unsigned, spark_protocol_event_status_fn, void*, void*))
DYNALIB_FN(BASE_IDX2 + 10, communication, spark_protocol_end_event, void(ProtocolFacade*, int, void*))
DYNALIB_FN(BASE_IDX2 + 11, communication, spark_protocol_read_event_data, int(ProtocolFacade*, int, char*, size_t, void*))
DYNALIB_FN(BASE_IDX2 + 12, communication, spark_protocol_write_event_data, int(ProtocolFacade*, int, const char*, size_t, bool, void*))
DYNALIB_FN(BASE_IDX2 + 13, communication, spark_protocol_event_data_bytes_available, int(ProtocolFacade*, int, void*))
DYNALIB_FN(BASE_IDX2 + 14, communication, spark_protocol_add_subscription, int(ProtocolFacade*, const char*, spark_protocol_subscription_fn, void*, void*))
