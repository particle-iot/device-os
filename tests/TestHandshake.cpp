...
struct HandshakeFixture
{
  ...
  static const uint8_t encrypted_aes_credentials[256];
  static const uint8_t expected_hmac[20];
...
const uint8_t HandshakeFixture::private_key[1153] =
  // modulus N
...
const uint8_t HandshakeFixture::encrypted_aes_credentials[256] = {
...
const uint8_t HandshakeFixture::expected_hmac[20] = {
  0x0d, 0xf9, 0xc6, 0x4e, 0x9a, 0x6b, 0xf8, 0x7a,
  0x25, 0x13, 0xa3, 0x9c, 0x17, 0x4f, 0x08, 0xe3,
  0x25, 0x68, 0x23, 0x4a };

const uint8_t HandshakeFixture::signature[256] = {
