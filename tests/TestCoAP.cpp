...
struct CoAPFixture
{
  static const uint8_t private_key[1153];
  static const uint8_t pubkey[256];
  static const uint8_t encrypted_credentials[256];
  static const uint8_t signature[256];
...
const uint8_t CoAPFixture::private_key[1153] =
  // modulus N
...
const uint8_t CoAPFixture::pubkey[256] = {
...
const uint8_t CoAPFixture::encrypted_credentials[256] = {
...
const uint8_t CoAPFixture::signature[256] = {
...
{
  return spark_protocol.init(private_key, pubkey, encrypted_credentials, signature);
}
...
SUITE(CoAP)
{
  ...
  TEST_FIXTURE(CoAPFixture, HelloResponseMatchesOpenSSL)
  {
    uint8_t expected[16] = {
