...
SUITE(CoAP)
{
  TEST(MessageTypeEnumExists)
  {
    CoAPMessageType::Enum message_type;
    message_type = CoAPMessageType::FUNCTION_CALL;
    CHECK_EQUAL(CoAPMessageType::FUNCTION_CALL, message_type);
  }

  TEST_FIXTURE(CoAPFixture, SparkProtocolInitSucceeds)
  {
    CHECK_EQUAL(0, spark_protocol.init(private_key, pubkey, encrypted_credentials, signature));
  }
  ...
  TEST_FIXTURE(CoAPFixture, ReceivedMessageReturnsCoAPMessageTypeFunction)
  {
    ...
    spark_protocol.init(private_key, pubkey, encrypted_credentials, signature);
    CoAPMessageType::Enum message_type;
