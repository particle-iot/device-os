...
### BUGFIXES
- [Argon / Boron] Fixes an issue with NCP client getting stuck in a half-initialized state during early initialization (#1705)
- [Gen 3] Fixes USBSerial SOS issue when removing USB cable from battery powered device (#1707)
