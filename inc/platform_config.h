...
#define USB_DISCONNECT_PIN               	0//GPIO_Pin_10
#define USB_DISCONNECT_GPIO_PORT       		0//GPIOB
#define USB_DISCONNECT_GPIO_CLK		  		0//RCC_APB2Periph_GPIOB

#define USB_LP_CAN1_RX0_IRQn				0//For compiling the code without errors
