...
#elif (PLATFORM_ID == PLATFORM_ASOM) || (PLATFORM_ID == PLATFORM_BSOM) || (PLATFORM_ID == PLATFORM_XSOM) || (PLATFORM_ID == PLATFORM_QSOM)
        D4, D5, D6, D7, A0, A1, A7 /* , RGBR, RGBG, RGBB */
# if PLATFORM_ID != PLATFORM_BSOM || (PLATFORM_ID == PLATFORM_QSOM) || !HAL_PLATFORM_POWER_MANAGEMENT
        ,
        A6
