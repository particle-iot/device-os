...
BleCharacteristic verAttr("Version", PROPERTY::READ, verCharUuid, bleCtrlReqSvcUuid);
BleCharacteristic txAttr("Control TX", PROPERTY::NOTIFY, txCharUuid, bleCtrlReqSvcUuid);
BleCharacteristic rxAttr("Control RX", PROPERTY::WRITE | PROPERTY::WRITE_WO_RSP, rxCharUuid, bleCtrlReqSvcUuid, onDataReceived);
...
void setup() {
    ...
    BleCharacteristic myAttr("Custom", PROPERTY::READ, myCharUuid, mysvcUuid);
    BLE.addCharacteristic(myAttr);
}
