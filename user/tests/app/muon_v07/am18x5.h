...
#define HAL_PLATFORM_EXTERNAL_RTC_I2C (HAL_I2C_INTERFACE1)
#define HAL_PLATFORM_EXTERNAL_RTC_I2C_ADDR (0x69)
#define HAL_PLATFORM_EXTERNAL_RTC_CAL_XT (-45)

#define RTC_INT                 PIN_INVALID
#define RTC_WDI                 PIN_INVALID
...
private:
    ...
    std::pair<uint8_t, uint8_t> intPin_ = {MCP23S17_PORT_A, 1};
