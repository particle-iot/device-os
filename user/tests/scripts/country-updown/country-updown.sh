...
export PHOTON_SP1_111="https://github.com/particle-iot/device-os/releases/download/v1.1.1/photon-system-part1@1.1.1.bin"
export PHOTON_SP2_111="https://github.com/particle-iot/device-os/releases/download/v1.1.1/photon-system-part2@1.1.1.bin"
...
curl_all_required_system_parts() {
  ...
  if [ ! -e "system-part1-1.1.1-photon.bin" ]; then
    curl --fail -L "$PHOTON_SP1_111" -o "system-part1-1.1.1-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  fi
  if [ ! -e "system-part2-1.1.1-photon.bin" ]; then
    curl --fail -L "$PHOTON_SP2_111" -o "system-part2-1.1.1-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  fi
...
# ----+---------+---------+---------+------------+---------+-----------------+----------------------
#  89 |   JP2   |   050   | DEFAULT |   111      |   N/A   |   070/063/050   | online
#  90 |   JP2   |   050   | DEFAULT | 051/111    |   N/A   |   070/063/050   | online
#  91 |   JP2   |   050   | DEFAULT |   111      |   N/A   |   070/063/051   | online
#  92 |   JP2   |   050   | DEFAULT |   111      |   JP2   |   070/063/050   | online
#  93 |   JP2   |   050   | DEFAULT | 051/111    |   JP2   |   070/063/050   | online
#  94 |   JP2   |   050   | DEFAULT |   111      |   JP2   |   070/063/051   | online
#  95 |   JP2   |   050   | DEFAULT |   111      |   GB0   |   070/063/050   | wiped creds, re-enter
#  96 |   JP2   |   050   | DEFAULT |   111      | DEFAULT |   070/063/050   | re-test, online
# ----+---------+---------+---------+------------+---------+-----------------+----------------------
...
if true; then
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 89 |   JP2   |   050   | DEFAULT |   111      |   N/A   |   070/063/050   | online                 |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  enter_dfu_mode
  try set_country JP2
  exit_dfu_mode
  ...
  enter_dfu_mode
  try dfu_system 1.1.1 photon
  try exit_dfu_mode

  # wait for 1.1.1 bootloader from SMH
  sleep 30
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 90 |   JP2   |   050   | DEFAULT | 051/111    |   N/A   |   070/063/050   | online                 |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  enter_dfu_mode
  try set_country JP2
  exit_dfu_mode
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 91 |   JP2   |   050   | DEFAULT |   111      |   N/A   |   070/063/051   | online                 |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  enter_dfu_mode
  try set_country JP2
  exit_dfu_mode
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 92 |   JP2   |   050   | DEFAULT |   111      |   JP2   |   070/063/050   | online                 |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  enter_dfu_mode
  try set_country JP2
  exit_dfu_mode
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 93 |   JP2   |   050   | DEFAULT | 051/111    |   JP2   |   070/063/050   | online                 |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  enter_dfu_mode
  try set_country JP2
  exit_dfu_mode
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 94 |   JP2   |   050   | DEFAULT |   111      |   JP2   |   070/063/051   | online                 |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  enter_dfu_mode
  try set_country JP2
  exit_dfu_mode
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 95 |   JP2   |   050   | DEFAULT |   111      |   GB0   |   070/063/050   | wiped creds, re-enter  |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  enter_dfu_mode
  try set_country JP2
  exit_dfu_mode
  ...
  heading
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
  echo "| 96 |   JP2   |   050   | DEFAULT |   111      | DEFAULT |   070/063/050   | re-test, online        |"
  echo "+----+---------+---------+---------+------------+---------+-----------------+------------------------+"
