...
export PHOTON_SP1_121_RC3="https://github.com/particle-iot/device-os/releases/download/v1.2.1-rc.3/photon-system-part1@1.2.1-rc.3.bin"
export PHOTON_SP2_121_RC3="https://github.com/particle-iot/device-os/releases/download/v1.2.1-rc.3/photon-system-part2@1.2.1-rc.3.bin"
export PHOTON_SP1_121_RC3_MOD=1212
export PHOTON_SP2_121_RC3_MOD=1212
...
export PHOTON_SP1_140_RC1="https://github.com/particle-iot/device-os/releases/download/v1.4.0-rc.1/photon-system-part1@1.4.0-rc.1.bin"
export PHOTON_SP2_140_RC1="https://github.com/particle-iot/device-os/releases/download/v1.4.0-rc.1/photon-system-part2@1.4.0-rc.1.bin"
export PHOTON_SP1_140_RC1_MOD=1400
export PHOTON_SP2_140_RC1_MOD=1400
...
set_baudrate() {
  ...
  if [ "$OS" = "Linux" ]; then
    ...
    port_path="/dev/cu.usbmodem"
  fi
  local x=`compgen -f -- "${port_path}"`;
  if [ -z "${x}" ]; then
    ...
    if [ "$OS" = "Linux" ]; then
      eval $(${DIR}/../../../../build/serial_switcher.py ${baudrate} ${port});
    else
      eval $(stty -f ${port} ${baudrate});
    fi
  fi
  return 0;
}
...
# | 64 | photon | 1.2.1      | 1.4.0-rc.1           | part2, part1 | no, part2 rejected | ok      |
# | 65 | photon | 1.2.1      | 1.4.0-rc.1           | part1, part2 | yes                | ok      |
# ------------------------ downgrade -------------------------------------------------------------+
# | 65 | photon | 1.4.0-rc.1 | 1.2.1                | part1, part2 | no, part1 rejected | ok      |
# | 66 | photon | 1.4.0-rc.1 | 1.2.1                | part2, part1 | yes                | ok      |
...
# | 70 | photon | 0.7.0      | 0.6.3                | part2, part1 | yes                | ok      |
# | 71 | photon | 0.6.3      | 0.5.5                | part1, part2 | no, part1 rejected | ok      |
# | 72 | photon | 0.6.3      | 0.5.5                | part2, part1 | yes                | ok      |
# | 73 | photon | 0.5.5      | 0.5.2                | part1, part2 | no, part1 rejected | ok      |
# | 74 | photon | 0.5.5      | 0.5.2                | part2, part1 | yes                | ok      |
# ------------------------------------------------------------------------------------------------+
#
# Not tested any more...
# --------------------------------------------------------------------------------------------------+
...
if true; then
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 64 | photon | 1.2.1      | 1.4.0-rc.1           | part2, part1 | no, part2 rejected | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  ymodem_part 2 1.4.0-rc.1 photon
  enter_dfu_mode
  try exit_dfu_mode
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 65 | photon | 1.2.1      | 1.4.0-rc.1           | part1, part2 | yes                | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  try ymodem_part 1 1.4.0-rc.1 photon
  try run_cli_list_subcommand_and_confirm_device_shows_up_as_online
  enter_ymodem
  try serial_inspect
  try compare_system_version 1 ${PHOTON_SP1_140_RC1_MOD}
  try compare_system_version 2 ${PHOTON_SP2_121_MOD}

  enter_ymodem
  try ymodem_part 2 1.4.0-rc.1 photon
  # wait for 1.4.0-rc.1 bootloader from SMH
  particle flash --serial bootloader-1.4.0-rc.1-photon.bin
  sleep 30
  ...
  try serial_inspect
  try compare_system_version 1 ${PHOTON_SP1_140_RC1_MOD}
  try compare_system_version 2 ${PHOTON_SP2_140_RC1_MOD}
  pass
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 66 | photon | 1.4.0-rc.1 | 1.2.1                | part1, part2 | no, part1 rejected | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 67 | photon | 1.4.0-rc.1 | 1.2.1                | part2, part1 | yes                | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  try ymodem_part 2 1.2.1 photon
  try run_cli_list_subcommand_and_confirm_device_shows_up_as_online
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 68 | photon | 1.2.1      | 0.7.0                | part1, part2 | no, part1 rejected | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  ymodem_part 1 0.7.0 photon
  enter_dfu_mode
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 69 | photon | 1.2.1      | 0.7.0                | part2, part1 | yes                | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  try ymodem_part 2 0.7.0 photon
  try run_cli_list_subcommand_and_confirm_device_shows_up_as_online
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 70 | photon | 0.7.0      | 0.6.3                | part1, part2 | no, part1 rejected | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  ymodem_part 1 0.6.3 photon
  enter_dfu_mode
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 71 | photon | 0.7.0      | 0.6.3                | part2, part1 | yes                | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  try ymodem_part 2 0.6.3 photon
  try run_cli_list_subcommand_and_confirm_device_shows_up_as_online
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 72 | photon | 0.6.3      | 0.5.5                | part1, part2 | no, part1 rejected | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  ymodem_part 1 0.5.5 photon
  enter_dfu_mode
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 73 | photon | 0.6.3      | 0.5.5                | part2, part1 | yes                | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  try ymodem_part 2 0.5.5 photon
  try run_cli_list_subcommand_and_confirm_device_shows_up_as_online
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 74 | photon | 0.5.5      | 0.5.2                | part1, part2 | no, part1 rejected | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  ymodem_part 1 0.5.2 photon
  enter_dfu_mode
  ...
  heading
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  echo "| 75 | photon | 0.5.5      | 0.5.2                | part2, part1 | yes                | ok     |"
  echo "+----+--------+------------+----------------------+--------------+--------------------+--------+"
  enter_ymodem
  try ymodem_part 2 0.5.2 photon
  try run_cli_list_subcommand_and_confirm_device_shows_up_as_online
...
curl_all_required_system_parts() {
  ...
  # if [ ! -e "system-part1-1.2.1-rc.3-photon.bin" ]; then
  #   curl -L "$PHOTON_SP1_121_RC3" -o "system-part1-1.2.1-rc.3-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  # fi
  # if [ ! -e "system-part2-1.2.1-rc.3-photon.bin" ]; then
  #   curl -L "$PHOTON_SP2_121_RC3" -o "system-part2-1.2.1-rc.3-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  # fi

  if [ ! -e "system-part1-1.2.1-photon.bin" ]; then
    curl -L "$PHOTON_SP1_121" -o "system-part1-1.2.1-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  fi
  if [ ! -e "system-part2-1.2.1-photon.bin" ]; then
    curl -L "$PHOTON_SP2_121" -o "system-part2-1.2.1-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  fi

  if [ ! -e "system-part1-1.4.0-rc.1-photon.bin" ]; then
    curl -L "$PHOTON_SP1_140_RC1" -o "system-part1-1.4.0-rc.1-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  fi
  if [ ! -e "system-part2-1.4.0-rc.1-photon.bin" ]; then
    curl -L "$PHOTON_SP2_140_RC1" -o "system-part2-1.4.0-rc.1-photon.bin"; if [[ "$?" -ne 0 ]]; then return 1; fi
  fi
