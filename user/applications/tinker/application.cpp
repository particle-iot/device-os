...
const PinMapping g_pinmap[] = {
    // Gen 2
#if (PLATFORM_ID > PLATFORM_GCC && PLATFORM_ID <= PLATFORM_ELECTRON_PRODUCTION)
...
# endif // PLATFORM_ID == PLATFORM_TRACKER
    ...
    PIN(D19), PIN(D20), PIN(D21), PIN(D22),
...
#if defined(SYSTEM_VERSION_v080RC1) && SYSTEM_VERSION >= SYSTEM_VERSION_v080RC1 && (!defined(HAL_PLATFORM_WIFI_SCAN_ONLY) || !HAL_PLATFORM_WIFI_SCAN_ONLY)
STARTUP(System.enableFeature(FEATURE_WIFITESTER));
#endif // defined(SYSTEM_VERSION_v080RC1) && SYSTEM_VERSION >= SYSTEM_VERSION_v080RC1 && (!defined(HAL_PLATFORM_WIFI_SCAN_ONLY) || !HAL_PLATFORM_WIFI_SCAN_ONLY)
