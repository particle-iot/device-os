...
CRC_LEN = 4
CRC_BLOCK_LEN = 38
MODULE_INFO_SUFFIX_LEN = 36
MODULE_INFO_CRC_LEN = 4
MODULE_INFO_SUFFIX_AND_CRC_LEN = 40
...
%.bin : %.elf
	$(call echo,'Invoking: ARM GNU Create Flash Image')
	$(VERBOSE)$(OBJCOPY) -O binary --gap-fill 0xFF $< $@.pre_crc
	...
	tail -c $(MODULE_INFO_SUFFIX_AND_CRC_LEN) $@.pre_crc > $@.module_info_suffix_and_crc; \
	head -c $(MODULE_INFO_SUFFIX_LEN) $@.module_info_suffix_and_crc > $@.module_info_suffix; \
	tail -c $(MODULE_INFO_CRC_LEN) $@.module_info_suffix_and_crc > $@.module_info_crc; \
	$(VERBOSE)$(OBJCOPY) --update-section .module_info_suffix=$@.module_info_suffix $<; \
	$(VERBOSE)$(OBJCOPY) --update-section .module_info_crc=$@.module_info_crc $<; \
	fi
	$(VERBOSE)[ ! -f $@ ] || rm $@
	$(VERBOSE)mv $@.pre_crc $@
	$(call echo,)
