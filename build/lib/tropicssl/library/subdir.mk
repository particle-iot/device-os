...
lib/tropicssl/library/%.o: ../lib/tropicssl/library/%.c
	...
	arm-none-eabi-gcc -I"../lib/tropicssl/include" -I"../src" -Os -ffunction-sections -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -mcpu=cortex-m3 -mthumb -g3 -gdwarf-2 -o "$@" "$<"
